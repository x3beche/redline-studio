...
**Tools** is a tab of its own, just left of Analytics on the top bar: small
calculators and sketch pads for any room. What each tool does, and how to add
one, is in **[TOOLS.md](TOOLS.md)**.
