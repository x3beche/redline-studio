...
- [ ] **Auto English translate**: a switch in the comment form (not next to
...
- [ ] **Apple-style switches**: the toggles should be on/off switches, not
      chips.
- [ ] **Before / after pictures**: take an "after" shot when a revision is
      finished and show it beside the drawing on the card.
- [ ] **Build indicator**: while a model is building nothing on screen says
...
- [ ] **Right column padding**: too much of it, squeezing the content.
- [ ] Push everything.
