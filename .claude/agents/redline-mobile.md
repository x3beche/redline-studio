...
Run the commands as yourself: `X3_AGENT="mobile room"`. With sign-in on,
...
`revisions.py chat --room mobile` and answer in it with
`revisions.py say --room mobile "..."`; `wait --room mobile` listens to it
