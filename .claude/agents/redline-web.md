...
Run the commands as yourself: `X3_AGENT="web room"`. With sign-in on,
...
`revisions.py chat --room web` and answer in it with
`revisions.py say --room web "..."`; `wait --room web` listens to it
