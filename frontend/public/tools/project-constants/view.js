// The project record: this tool's list of constants is one shared document per
// project in the app (/api/tools/data/project-constants?project=<name>), so every room
...
const KEYS = ['constants'];          // the inputs that make up the record
